...
func TestEnvironmentStruct(t *testing.T) {
	env := &Environment{
		...
		NamespacePIDFile: "/home/test-env-a1b2/namespace.pid",
	}
	...
	if env.NamespacePIDFile != "/home/test-env-a1b2/namespace.pid" {
		t.Errorf("Expected NamespacePIDFile to be '/home/test-env-a1b2/namespace.pid', got %s", env.NamespacePIDFile)
	}
}
